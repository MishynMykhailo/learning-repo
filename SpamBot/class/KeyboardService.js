class KeyboardService {
  ...
  // Чтобы работало нужно вызывать resize_keyboard как функцию у replyKeyboardMarkup,
  // example: replyKeyboardMarkup([{ text: HI }]).resize_keyboard()
  replyKeyboardMarkup(buttons = [{ text }]) {
    const replyMarkup = {
      keyboard: [[...buttons]],
